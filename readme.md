...
| 이름   | 역할                 | 개발내용                                                     |
| ------ | -------------------- | ------------------------------------------------------------ |
| 이진행 | 팀장, Back-end       | - JPA 기반 Entity 설계<br />- ERD 설계<br />- 스프링 S3 연동하여 파일 저장 및 다운로드<br />- 검색 기능(제목, 제목+내용, 글쓴이) 개발<br />- 페이지 제네이션<br />- QueryDsl을 활용하여 동적쿼리작성<br />- 문의사항, 공지사항, 메세지, FAQ 페이지 목록조회<br />- 문의사항, 공지사항, 메세지 제목,내용,제목+내용 검색 기능<br />- 게시물 댓글 작성 및 댓글 파일첨부 기능<br /> |
