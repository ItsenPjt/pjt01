...
- 마이페이지에서 회원 정보 수정 및 탈퇴를 할 수 있습니다.
...
| 이름   | 역할                 | 개발내용                                                     |
| ------ | -------------------- | ------------------------------------------------------------ |
| 이진행 | 팀장, Back-end       | - JPA 기반 Entity 설계<br />- ERD 설계<br />- 스프링 S3 연동하여 파일 저장, 삭제 및 다운로드<br />- 검색 기능(제목, 제목+내용, 글쓴이) 개발<br />- 페이지 제네이션<br />- QueryDsl을 활용하여 동적쿼리작성<br />- 문의사항, 공지사항, 메세지, FAQ 페이지 작성, 수정, 조회, 삭제<br />- 문의사항, 공지사항, 메세지 제목, 내용, 제목+내용 검색 기능<br />- 게시물 댓글 작성 및 댓글 파일첨부 기능<br /> |
| 이진혁 | Back-end & Front-end |                                                              |
| 박승연 | Back-end & Front-end | - (BE) 공지사항 목록 조회, 작성, 수정, 삭제 API 개발<br />- (BE) 공지사항 파일 등록, 수정, 삭제 API 개발<br />- (FE) 전체 페이지 기본 레이아웃 세팅 및 파비콘 설정<br />- (FE) 공지사항 & 문의사항 게시물 조회, 작성, 수정, 삭제 컴포넌트 구현<br />- (FE) 공지사항 & 문의사항 게시물 파일 조회, 작성, 수정, 삭제 컴포넌트 구현<br />- (FE) 공지사항 & 문의사항 댓글 조회, 작성, 삭제, 파일 등록 컴포넌트 구현<br />- (FE) 공지사항 & 문의사항 & 자주 묻는 질문 & 메세지 검색(제목, 제목 + 내용, 글쓴이) 컴포넌트 구현<br />- (FE) 헤더, 푸터 컴포넌트 구현 |
| 허진영 | Back-end & Front-end | - JPA 기반 Entity 설계<br />- ERD 설계<br />- 회원가입 / 회원정보 수정 /회원탈퇴 API 개발<br />- 로그인 / 로그아웃 API 개발<br />- QueryDsl을 활용하여 동적쿼리작성<br />- React를 활용한 View 개발 및 npm build<br />- AWS를 활용한 서버 셋팅 및 운영관리 (IAM, EC2, RDS, S3)<br />- 도메인 관리 및 운영 (DNS NameServer) |
...
| 허진영 | - 이번 뉴센 프로젝트를 진행하면서 인사팀 및 신입 교육생들을 위한<br/>사내 교육 홈페이지 개발이라는 기획을 하였습니다.<br/>기존에 사용하던 Maven, JSP 등의 기술 환경이 아닌<br/>처음 사용해 보는 React, JPA, JPQL, QueryDsl 등을 활용하여 개발을 진행하였습니다.<br/>익숙하지 않은 새로운 방법으로 개발을 진행하다 보니<br/>개발을 시작할 당시 제가 맡은 회원관리 및 로그인 기능을<br/>어떻게 구현해야 할지에 대한 어려움이 있었습니다.<br/>하지만 공식 참고 자료 등을 활용하여 하나씩 해결해 나갈 수 있었고,<br/>새로운 기술을 경험해 보니 기존의 방식보다 편리하게 개발에 임할 수 있다는 것을 느꼈습니다.<br/>- 또한 SpringBoot, JPA를 통한 개발 및 AWS를 활용한 인프라 구성에 있어<br/>새로운 것을 활용하더라도 역시나 이전 기술들과 기본 개념이<br/>가장 중요하다는 것을 다시 한번 느끼게 되는 프로젝트였습니다.<br/>앞으로도 꾸준한 자기개발을 통하여 개인 역량을 높여<br/>스스로 부족한 부분을 채워나가야겠다는 생각이 들었고,<br/>또한 이러한 점들이 다시 묵묵히 공부를 할 수 있게 되는<br/>또 하나의 동기부여가 된 듯하여 보람 있었던 그런 프로젝트였던 것 같습니다. |
