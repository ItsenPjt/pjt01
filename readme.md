...
| 이름   | 역할                 | 개발 내용                                                    |
| ------ | -------------------- | ------------------------------------------------------------ |
| 이진행 | 팀장, Back-end       | - JPA 기반 Entity 설계<br />- ERD 설계<br />- 스프링 S3 연동하여 파일 저장 및 다운로드<br />- 검색 기능(제목, 제목+내용, 글쓴이) 개발<br />- 페이지 제네이션<br />- QueryDsl을 활용하여 동적쿼리작성<br />- 문의사항, 공지사항, 메세지, 페이지 목록조회<br />- 문의사항, 공지사항, 메세지 제목,내용,제목+내용 검색기능<br /> |
| 이진혁 | Back-end & Front-end | - JPA 기반 Entity 설계<br />- ERD 설계<br />- 테스트 주도 계발 (TDD)<br />- 공통 및 커스텀 ExceptionHandler 구현 (메세지, FAQ, 관리자)<br />- 메세지 관련 기능 개발 <br />  (메세지 목록 조회 (보낸/받은), 메세지 상세 조회 (보낸/받은), 메세지 보내기 (개인/단체), 메세지 삭제,  답장하기)<br />- 검색 관련 기능 개발<br />  (실시간 수신자 검색)<br />- FAQ 관련 기능 개발<br />  (FAQ 목록, 상세, 등록, 수정, 삭제)<br />- 관리자 페이지<br />  (인증 코드 조회, 삭제, 등록, Gmail 연동, 랜덤 코드 생성, 회원 목록 조회, 삭제)<br />- 메세지 컴포넌트 생성<br />- FAQ 컴포넌트 생성<br />- 관리자페이지 컴포넌트 생성<br />- 공지사항, 문의사항, FAQ, 메세지 페이징 처리 |
